            ...
            <table class="table text-center bodyTable">
                ...
                <tbody>
                    @foreach ($positions as $position)
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    <a href="#updateModal{{ $position->id }}" class="link upt-link btn btn-u"
                                        data-bs-toggle="modal">Modifier</a>
                                </div>
                            </td>
                            <td class="pt-2">
                                <form action="{{ route('positions.destroy', ['position' => $position->id]) }}" method="POST"
                        ...
                        <div class="modal fade" id="updateModal{{ $position->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('positions.update', ['position' => $position->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')
                                            <label for="position-name" class="form-label">Nom du poste</label>
                                            <input type="text" class="form-control" id="position-name" name="name"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="add-position-form" action="{{ route('positions.store') }}" method="POST">
                                ...
                                <input type="text" class="form-control" id="new-position-name" name="name"
